...
class App(ctk.CTk):
    def __init__(self):
        ...
        # Branding
        self.logo_label = ctk.CTkLabel(self.sidebar, text="CODEC", font=ctk.CTkFont("Segoe UI", size=26, weight="bold"), text_color=self.accent_color)
        ...
        self.header = ctk.CTkLabel(self.main_view, text="Zero Codec Console", font=ctk.CTkFont("Segoe UI", size=32, weight="bold"), text_color=self.text_primary)
